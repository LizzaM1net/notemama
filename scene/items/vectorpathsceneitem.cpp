...
QList<ColorVector2D> VectorPath::LineSegment::generateVertices(QVector2D startPoint) const
{
...
QList<ColorVector2D> VectorPath::QuadCurveSegment::generateVertices(QVector2D startPoint) const
{
...
QList<ColorVector2D> VectorPath::CubicCurveSegment::generateVertices(QVector2D startPoint) const
{
...
QList<ColorVector2D> VectorPathSceneItem::generateVertices()
{
    ...
    for (const VectorPath::Segment* segment : std::as_const(segments)) {
        ...
        points << segment->generateVertices(point);
